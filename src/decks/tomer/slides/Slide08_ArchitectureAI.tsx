/**
 * Slide 08: DDN Infinia Architecture - The AI Era
 */
import { DiagramSlide } from './layouts'
import styles from './styles/Slide08.module.css'

export default function Slide08_ArchitectureAI() {
  return (
    <DiagramSlide title="DDN Infinia Architecture – the AI era" subtitle="Infinia 2.3 and Beyond">
        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.layerRow}>
            ...
            <div className={styles.protocolsGrid}>
              ...
              <span className={styles.protocolItemAI}>"Others"</span>
          ...
          <div className={styles.protocolDetails}>
            ...
            <div className={styles.protocolGroupAI}>
              <span className={styles.aiConnector}>Application connectors</span>
