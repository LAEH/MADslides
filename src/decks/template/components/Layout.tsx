...
// Slide names for navigation - customize these for your presentation
const SLIDE_NAMES = [
  'Title',
  'Outline',
  'Section',
...
export default function Layout({ children, title = 'DDN Slides', logo = '/ddn-logo.png' }: LayoutProps) {
  ...
  // Memoized presentation context value
        ...
        {!isEmbedded && <nav className={`${styles.nav} ${scrolled ? styles.scrolled : ''} ${isPresentationMode ? styles.presentationNav : ''}`}>
          <div className={styles.navInner}>
            ...
            <Link to="/" className={styles.logo}>
              <img src={logo} alt="DDN" className={styles.logoImg} />
            </Link>
